...
# Oracle iAS WebCache autostart setup for Solaris 8,9,10,>10, Linux
# Yuri Voinov (C) 2006-2010
#
# ident "@(#)inst_wcache.sh    2.5   10/11/01 YV"
#
...
INST_CONFIG_FILE="inst_wcache.conf"
...
$ECHO "#####################################################"
$ECHO "#    iAS WebCache autostart installation script     #"
$ECHO "#                                                   #"
